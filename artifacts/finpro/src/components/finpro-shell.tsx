  ...
  return <div className="app-shell">
    ...
    <div className="md:pl-[250px]">
      <header className="sticky top-0 z-20 flex h-[72px] items-center justify-between border-b border-border/80 bg-background/90 px-5 backdrop-blur-md md:px-9">
        ...
        <div className="flex items-center gap-3 md:ml-auto"><div className="hidden items-center gap-2 text-xs text-muted-foreground sm:flex"><span className="h-2 w-2 rounded-full bg-emerald-400" /> Dados salvos localmente</div><Button onClick={onAdd} className="h-9 rounded-lg bg-primary px-3 text-xs font-bold uppercase tracking-[.08em] text-primary-foreground" data-testid="button-add-transaction"><Plus className="h-4 w-4" /> <span>Lançar</span></Button></div>
      </header>
